...
// api/confirm.ts
var onRequestGet = /* @__PURE__ */ __name(async ({ request, env, waitUntil }) => {
  const token = new URL(request.url).searchParams.get("token") || "";
  const fail = /* @__PURE__ */ __name((reason) => Response.redirect(`${env.SITE_URL}/kayit-onay/?err=${reason}`, 302), "fail");
...
// ../.wrangler/tmp/pages-gbYs4E/functionsRoutes-0.3919299409553274.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-VZp7Kr/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-VZp7Kr/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9532925597400994.mjs.map
