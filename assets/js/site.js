...
const I18N = {
  tr: {
    ...
    refsTitle: "Referans Listemiz",
    refsLead: "Referans bilgilerinizi aşağıdaki form aracılığıyla bizimle paylaşabilirsiniz. Ekibimiz en kısa sürede sizinle iletişime geçecektir.",
    athleteTitle: "Sporcu Tanıma Formu",
    athleteLead: "Sporcu geçmişinizi ve hedeflerinizi daha iyi anlayabilmemiz için lütfen aşağıdaki formu doldurun.",
    cookieTitle: "Çerez Politikamız",
    cookieLead: "Web sitemizde çerezlerin nasıl kullanıldığına ilişkin bilgilendirme.",
    kvkkTitle: "KVKK Politikamız",
    kvkkLead: "Kişisel verilerinizin korunmasına ilişkin aydınlatma metni.",
    legalTrOnly: "Yasal metnimiz Türkçe olarak hazırlanmıştır.",
    formFallback: "Form görüntülenmiyorsa,",
    formFallbackLink: "buradan açabilirsiniz.",
    contactTitle: "İletişim",
    contactLead: "Bize aşağıdaki kanallardan ulaşabilir veya ücretsiz ön görüşme için randevu alabilirsiniz.",
    cAddress: "Adres",
    cPhone: "Telefon",
    cEmail: "E-posta",
    ...
    maiaLead: "Merhaba, ben MaiA. Size gelecek seçiminizde yardımcı olmak için buradayım. Size daha detaylı bir bilgilendirme yapabilmek için aşağıda sizden bazı bilgiler isteyeceğim. Bu bilgilere göre veritabanımızdaki okullar arasından size uygun olanları çıkartacak ve sizinle birlikte inceleyeceğim. Görüşmemizin herhangi bir yerinde “Bitir ve Özeti Gönder” butonuna basarak görüşmemizi bitirebilirsiniz. Bu durumda yaptığımız görüşmenin bir özeti size ve uzman ekibimize gönderilecektir. Uzman ekibimiz aldıkları bilgilendirmeye göre sizi arayarak seçim ve başvuru konusunda yardım sağlayacaklar. Haydi başlayalım!",
  ...
  en: {
    ...
    refsTitle: "Our Reference List",
    refsLead: "Share your reference details with us using the form below. Our team will get in touch with you shortly.",
    athleteTitle: "Athlete Recognition Form",
    athleteLead: "Please fill in the form below so we can better understand your athletic background and goals.",
    cookieTitle: "Cookie Policy",
    cookieLead: "Information on how cookies are used on our website.",
    kvkkTitle: "KVKK / Privacy Policy",
    kvkkLead: "Notice on the protection of your personal data.",
    legalTrOnly: "This legal notice is provided in Turkish.",
    formFallback: "If the form doesn't load,",
    formFallbackLink: "open it here.",
    contactTitle: "Contact",
    contactLead: "Reach us through the channels below, or book a free consultation.",
    cAddress: "Address",
    cPhone: "Phone",
    cEmail: "E-mail",
    cFollow: "Follow Us",
    ...
    maiaTitle: "Meet MaiA",
    maiaLead: "Hi, I'm MaiA. I'm here to help you choose your future. To give you more detailed guidance, I'll ask you a few questions below. Based on your answers, I'll pull the schools that fit you from our database and review them together with you. At any point in our conversation you can press the “Finish & send the summary” button to end our chat. In that case, a summary of our conversation will be sent to you and to our expert team. Based on that summary, our expert team will call you to help with your selection and application. Let's get started!",
