...
(function($) {
  var OffSet = {
    _setoffset: function(lists) {
      ...
      if (window.matchMedia("(max-width: 767px)").matches) {
        if (void 0 == lists.data("jltma-scroll-offset-mobile")) {
        ...
        if (void 0 == lists.data("jltma-scroll-offset-tablet")) {
          scroll_offset = lists.data("jltma-scroll-offset");
          return scroll_offset;
        } else {
    ...
    __jltma_toc_scroll_to_top_offset: function(lists, jltma_toc_scroll_to_top_offset) {
      if (window.matchMedia("(max-width: 767px)").matches) {
        if (void 0 == lists.data("jltma-scroll-to-top-offset-mobile")) {
        ...
        if (void 0 == lists.data("jltma-scroll-to-top-offset-tablet")) {
          return jltma_toc_scroll_to_top_offset;
        } else {
  ...
  var toc = function(options) {
    return this.each(function() {
      ...
      thisOptions = $.extend(
        ...
        { content: data.toc || void 0, headings: data.tocHeadings || void 0 },
        options
      );
      headingSelectors = thisOptions.headings.split(",");
      if (!$(thisOptions.content).find(thisOptions.headings).length) {
        var $widget_scope = $("body").find(".elementor-element-" + options.scope);
      ...
      $(thisOptions.content).find(thisOptions.headings).attr("id", function(index, attr) {
        ...
        var elem = $(this), level = $.map(headingSelectors, function(selector, index) {
          return elem.is(selector) ? index : void 0;
        })[0];
  ...
  var Master_Addons = {
    ...
    MATableOfContents: function($scope, $2) {
      var body_wrap = $2("body");
      ...
      wrapper.find(".jltma-toc-list a").on("click", function() {
        if ("" == scroll_offset || "undefined" == typeof scroll_offset) {
          $2("html, body").animate({
            scrollTop: $2($2.attr(this, "href")).offset().top - 30
          }, scroll_delay);
        } else {
          $2("html, body").animate({
            scrollTop: $2($2.attr(this, "href")).offset().top - scroll_offset
          }, scroll_delay);
        }
        $scope.find(".jltma-toc-list a").not(this).removeClass("jltma-toc-active-heading");
        $2(this).addClass("jltma-toc-active-heading");
        return false;
      });
      $scope.find(".jltma-toc-wrapper li").each(function(i) {
        $2(this).attr("id", "toc-li-" + i);
      });
      ...
      $2(document).on("scroll", Master_Addons.MATableOfContentsScroll);
    }
  };
